#
# Testing App::Fenix::Config::Screen
#
use Path::Tiny;
use Test2::V0;
...
use App::Fenix::Config::Screen::Details;
...
subtest 'screen section without details' => sub {
    #$args->{scrcfg} = 'simple';
    my $scrcfg_file = path 't/configs/apps/test-cfg/scr/simple.conf';
    ...
    ok my $scr_det
        = App::Fenix::Config::Screen::Details->new( details => $details, ),
        'new details object';
...
#     ok my $conf = App::Fenix::Config::Screen->new($args),
#         'new config screen object';
