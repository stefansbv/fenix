package App::Fenix::Tk::App::Demo::Orders;
...
sub run_screen {
    ...
    $self->_init($args);                     # initilalization - required
    ...
    my $dorderdate = $frame1->DateEntry(
        ...
        -parsecmd   => sub {
            $self->dateentry_parse_date( $date_format, @_ );
        },
        -formatcmd => sub {
...
=head1 SYNOPSIS
    ...
    require App::Fenix::App::Demo::Orders;

    my $scr = App::Fenix::App::Demo::Orders->new;
